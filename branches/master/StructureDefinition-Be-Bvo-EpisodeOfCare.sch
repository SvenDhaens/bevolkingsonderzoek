...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:EpisodeOfCare">
      <sch:assert test="count(f:extension[@url = 'https://www.ehealth.fgov.be/standards/fhir/StructureDefinition/BvoConditionCode']) &lt;= 1">extension with URL = 'https://www.ehealth.fgov.be/standards/fhir/StructureDefinition/BvoConditionCode': maximum cardinality of 'extension' is 1</sch:assert>
